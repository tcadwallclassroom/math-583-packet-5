...
What we have just performed is sometimes called a *Monte Carlo* estimate of the p-value. This is really useful for situations where we may not have a convenient probability distribution to work with. 